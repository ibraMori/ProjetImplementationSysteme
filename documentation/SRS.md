...
## 2. Portée (Scope)
### 2.1 Inclus (IN)
- IN-1: guide d integration pour les nouveaux immigrants 
...
- IN-7:interface simple et accessible en francais
...
- **Règles métier :** <validation, calculs, permissions, etc.>
  ...
  -Un utilisateur peut modifier son profil et son niveau d'integration.
  ...
  - Le système doit être disponible 24h/24, sauf maintenance.
